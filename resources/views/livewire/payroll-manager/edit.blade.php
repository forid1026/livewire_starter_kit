<flux:modal name="edit-payroll" class="md:w-[600px]"  style="width: 600px;">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">Update Payroll</flux:heading>
        ...
        <button type="submit" class="w-full py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700" wire:click="updatePayroll">
            Update Payroll
        </button>
    </div>
</flux:modal>
